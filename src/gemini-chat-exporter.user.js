...
// @namespace            https://github.com/AstridStark25963/gemini-chat-exporter/hahahaha
// @version              1.0.1
...
(function () {
    ...
    GM_addStyle(`
        ...
        .gemini-export-circle-btn:hover { background: #1557b0; transform: scale(1.1); }
    ...
    const MarkdownParser = {
        parseNode: function(node) {
            ...
            if (node.nodeType === 1) {
                ...
                if (text === "Export to Sheets" || text === "Export to Google Sheets") {
                    return "";
                }
            }
            ...
            switch (node.nodeName) {
                case "H1": case "H2": case "H3":
                    ...
                    return `\n${"#".repeat(parseInt(level) + 2)} ${node.textContent.trim()}\n`;
                ...
                case "OL":
                    ...
                    Array.from(node.children).forEach((li, i) => {
                        if(li.nodeName === "LI") {
                             olText += `${i+1}. ${this.parseChildren(li).trim()}\n`;
                        }
                    });
                    return olText;
                ...
                case "ANNOTATION":
                    if (node.getAttribute("encoding") === "application/x-tex") {
